...
// Configura��o do sistema de log personalizado
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "API Poliview CRM", Version = "4.3.6" });
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("poliview.tecnologia.crm@2022.chave.segura.jwt.256bits")),
