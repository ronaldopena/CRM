<#
.SYNOPSIS
    Script para publicar o projeto Poliview.crm.api
.DESCRIPTION
...
try {
    Write-ColorOutput "Iniciando publicacao do Poliview.crm.api..." $InfoColor

    # Localizar dotnet CLI
    $dotnetPath = Find-DotNet

    # Verificar se o arquivo de projeto existe
    $projectPath = ".\Poliview.crm.api.csproj"
    ...
    $publishDir = "C:/Deploy/CRM/$versao/api"
