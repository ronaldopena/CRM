<#
.SYNOPSIS
    Script para publicar o projeto poliview.crm.sla
.DESCRIPTION
...
try {
    Write-ColorOutput "Iniciando publicacao do poliview.crm.sla..." $InfoColor

    # Localizar dotnet CLI
    $dotnetPath = Find-DotNet

    # Verificar se o arquivo de projeto existe
    $projectPath = ".\poliview.crm.sla.csproj"
    ...
    $publishDir = "C:/Deploy/CRM/$versao/sla"
