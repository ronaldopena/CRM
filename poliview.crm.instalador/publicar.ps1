<#
.SYNOPSIS
    Script para publicar o projeto poliview.crm.instalador
.DESCRIPTION
    Compila o projeto .NET 8.0 Windows Forms como single-file self-contained para win-x64
.EXAMPLE
    .\publicar.ps1
#>
...
try {
    Write-ColorOutput "Iniciando publicacao do poliview.crm.instalador..." $InfoColor

    # Localizar dotnet CLI
    $dotnetPath = Find-DotNet

    # Verificar se o arquivo de projeto existe
    $projectPath = ".\poliview.crm.instalador.csproj"
    ...
    $publishDir = "C:/Deploy/CRM/$versao/instalador"
