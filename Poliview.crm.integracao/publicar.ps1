<#
.SYNOPSIS
    Script para publicar o projeto Poliview.crm.integracao
.DESCRIPTION
...
try {
    Write-ColorOutput "Iniciando publicacao do Poliview.crm.integracao..." $InfoColor

    # Localizar dotnet CLI
    $dotnetPath = Find-DotNet

    # Verificar se o arquivo de projeto existe
    $projectPath = ".\Poliview.crm.integracao.csproj"
    ...
    # Definir pasta de destino (assumindo que deve ser 'integracao' e não 'apicrm')
    $publishDir = "C:/Deploy/CRM/$versao/integracao"
