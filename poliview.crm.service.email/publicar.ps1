<#
.SYNOPSIS
    Script para publicar o projeto poliview.crm.service.email
.DESCRIPTION
...
try {
    Write-ColorOutput "Iniciando publicacao do poliview.crm.service.email..." $InfoColor

    # Localizar dotnet CLI
    $dotnetPath = Find-DotNet

    # Verificar se o arquivo de projeto existe
    $projectPath = ".\Poliview.crm.service.email.csproj"
    ...
    $publishDir = "C:/Deploy/CRM/$versao/email"
