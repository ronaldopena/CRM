...
namespace Poliview.crm.integracao.service
{
    public partial class ServicoIntegracao : ServiceBase
    {
        ...
        private void Execute(object state)
        {
            ...
            //var pathIntegracao = ConfigurationManager.AppSettings["pastaInstalacaoIntegracao"];
            //var exeIntegracao = ConfigurationManager.AppSettings["exeIntegracao"];

            //var pathEmail = ConfigurationManager.AppSettings["pastaInstalacaoEmail"];
            //var exeEmail = ConfigurationManager.AppSettings["exeEmail"];
